    <div id="footer">
        <div class="container footer">
            ...
            <div class="footer__mid">
                ...
                <!-- <a href="http://localhost:8080/frameLaravel/thehinh.vn/public/" title="" class="more">Xem tất cả hệ thống cửa hàng</a> -->
            </div>
            <div class="footer__right">
                <div class="title">Fanpage của chúng tôi</div>
                <div class="image">
                    <iframe src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2FThehinhvn-110506877371094%2F&tabs=timeline&width=100&height=100&small_header=true&adapt_container_width=true&hide_cover=false&show_facepile=true&appId=593832358156528" width="100%" height="100%" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true" allow="encrypted-media"></iframe>
                </div>
            </div>
        </div>
    </div>
